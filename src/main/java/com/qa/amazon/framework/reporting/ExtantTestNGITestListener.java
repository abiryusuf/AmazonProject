...
public class ExtantTestNGITestListener implements ITestListener {


    private static ExtantManager extentManager = ExtantManager.getInstance().init("Amazon.extent.html");
